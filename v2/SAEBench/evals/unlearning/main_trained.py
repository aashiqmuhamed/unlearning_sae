...
def run_eval(
    ...
    artifacts_folder = os.path.join("artifacts_trained_jumprelu_combined", EVAL_TYPE, config.model_name)
    ...
    for sae_release, sae_object_or_id in tqdm(
        ...
        # )
        sae_id = "custom_sae"
        sae = SAE.load_from_pretrained("/data/datasets/wmdp_test/trained_saes/gemma_scope_B_jumprelu_combined/av36lrz5/6148096")
...
def arg_parser():
    ...
    parser.add_argument(
        "--output_folder",
        type=str,
        default="eval_results/unlearning_trained_jumprelu_combined",
        help="Output folder",
    )
