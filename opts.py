...
def create_parser():
    ...
    parser.add_argument("--sae_id",default = "layer_7/width_65k/canonical", type=str, help="ID of the SAE")
    ...
    parser.add_argument("--clamp_values", type=int, nargs='+', default=[-10,-50,-100,-200], help="clamp values (default: [-10,-50,-100,-200])")
    parser.add_argument("--th_ratio", type=float, default=1e3, help="Threshold ratio (default: 1e3)")
    parser.add_argument("--llm_batch_size", type=int, default=1, help="Batch size for LLM (default: None)")
    #others
    # ...
    return parser
