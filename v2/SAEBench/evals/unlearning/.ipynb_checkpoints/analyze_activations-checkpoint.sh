...
MODEL_PATH="/data/datasets/wmdp_test/baselines/gradient_ascent_20250105/alpha_0/gradient_ascent/"
SAE_PATTERN="sae_bench_gemma-2-2b_topk_width-2pow14_date-1109"
BLOCK_PATTERN="blocks.5.hook_resid_post__trainer_2"
OUTPUT_DIR="/data/aashiq_muhamed/unlearning/SAEBench/evals/unlearning/eval_results/activation_analysis/"
