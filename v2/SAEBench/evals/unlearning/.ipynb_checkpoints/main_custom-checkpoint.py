...
from evals.unlearning.utils.eval_custom import run_eval_single_sae
...
def run_eval(
    ...
    artifacts_folder = os.path.join("artifacts_pareto", EVAL_TYPE, config.model_name)
...
def arg_parser():
    ...
    parser.add_argument(
        "--output_folder",
        type=str,
        default="eval_results/unlearning_pareto",
        help="Output folder",
    )
