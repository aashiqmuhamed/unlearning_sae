...
class UnlearningEvalConfig(BaseEvalConfig):
    ...
    retain_thresholds: list[float] = Field(
        default_factory=lambda: [500], #[0.01, 0.001, 0.002, 0.005], #[95, 90, 85, 80, 70, 60, 50], #[0.01, 0.001, 0.1, 1], #[0.001, 0.01],
    ...
    n_features_list: list[int] = Field(
        default_factory=lambda: [5, 10, 20, 30, 40, 50], #[20, 50, 100, 200, 500, 1000, 10000], # Not used
    ...
    multipliers: list[int] = Field(
        default_factory=lambda: [50, 100, 150, 200],
        title="Multipliers",
