...
class UnlearningEvalConfig(BaseEvalConfig):
    ...
    n_features_list: list[int] = Field(
        default_factory=lambda: [10, 20], #[10, 20, 30, 50, 100], #[20, 50, 100, 200, 500, 1000, 10000], # Not used
    ...
    multipliers: list[int] = Field(
        default_factory=lambda: [10,50,100,200, 250, 300], #[10,50,100,200, 250, 300, 350, 500],
        title="Multipliers",
